...
class Settings(BaseSettings):
    ...
    cors_methods: list[str] = Field(default_factory=lambda: ["*"], description="CORS allowed methods")
    cors_headers: list[str] = Field(default_factory=lambda: ["*"], description="CORS allowed headers")
    
    # Aurelian Configuration
    aurelian_workdir: Optional[str] = Field(default=None, description="Aurelian working directory")
